...
- [`docs/SECURITY-STATUS.md`](docs/SECURITY-STATUS.md): zero-knowledge scope, soundness classification, circuit hash review gate (Poseidon2 and Rescue Prime as candidates), bridge compatibility and production gates.
